-- ============================================================
-- solana-copilot — NEW Supabase project setup (single paste)
-- Run this whole file in the new project's SQL Editor.
-- Combines db/supabase_schema.sql + the dashboard-rehaul migration.
-- Idempotent (CREATE IF NOT EXISTS / policy guards) — safe to re-run.
-- ============================================================
...
-- evidence, and serial-deployer reputation. DROP+CREATE so column changes apply.
...
-- ---------- dashboard rehaul (mirror_counts + read-only anon policies) ----------
